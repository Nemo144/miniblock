...
export interface FetchAddressTransactionsResponse {
  ...
  total: number;
  results: Array<{
    tx: Transaction; // ✅ Changed from IDBTransaction to Transaction
    stx_sent: string;
    stx_received: string;
    block_height: number; // ✅ Added this since your function uses it
    events: {
      stx: TransactionEvent; // ✅ Changed from TransitionEvent to TransactionEvent
      ft: TransactionEvent;
